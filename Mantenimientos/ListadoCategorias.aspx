<%@ Page Title="Listado de Categorías" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ListadoCategorias.aspx.vb" Inherits="TenisApp.ListadoCategorias" %>
    ...
    <asp:UpdatePanel ID="updRegistro" runat="server">
        <ContentTemplate>
            ...
            <table>
                <tr>
                    <td>
                        <a id="AgregarCategoria" runat="server" href="AgregarCategoria" style="float: right;">Nueva Categoría</a>
                    </td>
                </tr>
                <tr>
                    <td>Nombre</td>
                    <td>
                        <asp:TextBox ID="txtIDCategoria" runat="server" Width="84%"></asp:TextBox></td>
                    <td>Descripción</td>
                    <td>
            ...
            <asp:GridView ID="gvCategorias" runat="server" AutoGenerateColumns="False" EmptyDataText="No existen registros que coincidan con su seleccion"
                ...
                <Columns>
                    <asp:BoundField DataField="Descripcion" HeaderText="Nombre de Categoría" SortExpression="Descripcion"></asp:BoundField>
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:ImageButton ID="cmdEditRecord" runat="server" CommandArgument='<%# Eval("IDCategoria")%>'
