<%@ Page Title="Listado de Juegos en el Torneo" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ListadoTorneoJuego.aspx.vb" Inherits="TenisApp.ListadoTorneoJuego" %>
    ...
    <asp:UpdatePanel ID="updRegistro" runat="server">
        <ContentTemplate>
            ...
            <table>
                <tr>
                    <td colspan="4">
                        <a id="AgregarTorneoJuego" runat="server" href="AgregarTorneoJuego" style="float: right;">Nuevo Juego</a>
                    </td>
                </tr>
                <tr>
                    <td>
